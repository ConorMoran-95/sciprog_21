For the final practical, we will take a look at the tower of hanoi puzzle. We will write a function that prints on screen the sequence of moves required to solve the puzzle for any given number n.
